...
I created a faux continuous sequence of theta values by creating a vector of very small values between 0 and 1.5 theta. I then applied althams binomial distribution to the 'continuous' theta values looking for where X is exactly 6, or win the game. 
